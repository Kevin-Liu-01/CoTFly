...
export default {
  ...
  terrain: {
    ...
    roads: { paths: [
      // Explicit approach bearings meet the north/south boundary normally;
      // completing an oblique interior tangent cut diagonally across the rim.
      [[-420, -480], [-420, -450], [-346, -278], [-316, -90], [-330, 108], [-276, 290], [-202, 468], [-202, 480]],
      [[-112, -480], [-112, -466], [-146, -304], [-154, -168], [-172, -28], [-138, 142], [-86, 316], [-18, 466], [-18, 480]],
      [[330, -480], [330, -452], [286, -282], [246, -122], [226, 42], [258, 218], [212, 410], [212, 480]],
    ...
    landforms: [
      // Long unequal trough walls and broken saddles, not a mirrored ring of domes.
      { kind: 'ridge', x: -286, z: 22, length: 390, width: 86, height: 10.8, yawDeg: 7, corridorScale: 0.78,
        relief: { kind: 'glacial', startX: -408, startZ: -278, endX: -244, endZ: 284,
          leftWidthM: 86, rightWidthM: 38, bendM: -24, branchSide: 1, notchAtFraction: 0.55 } },
      { kind: 'ridge', x: 282, z: 28, length: 370, width: 84, height: 10.2, yawDeg: -8, corridorScale: 0.78,
        relief: { kind: 'glacial', startX: 174, startZ: -340, endX: 366, endZ: 248,
          leftWidthM: 44, rightWidthM: 118, bendM: 38, branchSide: -1, notchAtFraction: 0.64 } },
      { kind: 'ridge', x: -64, z: 292, length: 230, width: 70, height: 7.0, yawDeg: 80,
        relief: { kind: 'glacial', startX: -224, startZ: 306, endX: 196, endZ: 238,
          leftWidthM: 62, rightWidthM: 34, bendM: -22, branchSide: 1, notchAtFraction: 0.36 } },
      { kind: 'knoll', x: 154, z: -254, rx: 86, rz: 64, height: 6.4, yawDeg: 22,
        relief: { kind: 'glacial', startX: -84, startZ: -286, endX: 232, endZ: -344,
          leftWidthM: 30, rightWidthM: 72, bendM: 28, branchSide: -1, notchAtFraction: 0.62 } },
      { kind: 'basin', x: -166, z: -218, rx: 96, rz: 70, height: -3.0, yawDeg: -16,
        relief: { kind: 'glacial', startX: -178, startZ: -280, endX: -82, endZ: 214,
          leftWidthM: 64, rightWidthM: 42, bendM: -22, branchSide: 1, notchAtFraction: 0.35 } },
    ],
  },
  spawns: {
    player: { x: -222, z: -386 },
