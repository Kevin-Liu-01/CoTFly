...
| --- | --- |
| Playable fleet | 171 production-visible and 208 keyed local-development first-party procedural vehicles |
...
At the time of this document update it reports 181 first-party procedural battle
...
The canonical saved-roster report separately tracks all 210 records, including
